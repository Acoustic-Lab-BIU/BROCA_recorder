...
class RecorderWindow:
    def __init__(self, win, saved_path: Path, speaker_id, sentence_sheet_path:Path= None):
        ...
        previous_button = tk.Button(
            self.window, text="Previous", command=self.previous_sentence)
        ...
        self.timerFrame_sen = tk.LabelFrame(
            self.window, padx=10, pady=10, bd=0)
    ...
    def display_sentence(self):
        ...
        self.sen_num.config(text="Sentence index " +
                            str(self.current_sentence+1))